...
num_dense1 = np.random.randint(100, 150)
num_dense2 = np.random.randint(100, 150)
...
STAMP = 'lstm_%d_%d_%.2f_%.2f'%(num_lstm, num_dense1, num_dense2, rate_drop_lstm, \
        rate_drop_dense)
...
hist = model.fit([data_1_train, data_2_train, leaks_train], labels_train, \
        ...
        epochs=300, batch_size=2048, shuffle=True, \
